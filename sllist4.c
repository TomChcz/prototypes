/****************************************************
 *                                                  *
 * Singly linked list in c, dynamic version         *
 *                                                  *
 * usage ./sllist4                                  *
 *                                                  *
 ****************************************************/
...
int main(void)
{
    ...
    while(choice !=6)
    {
        ...
        {
            case 1:
                printf("\nPlease provide value for the first node: ");                
            ...
            case 2:
                printf("\nPlease enter value for another node: ");
                scanf("%d", &switch_value);
...
sllnode* create(int y)
{
    // complete check if list already exists, need to pass root value, and execute only if NULL aka does not exist
